...
public class PlatformMainInventory implements IInventoryHolder {
    ...
    public PlatformMainInventory(InventoriesHolder inventoriesHolder) {
        ...
        InventoryItem WAND_ITEM = new InventoryItem(Material.BLAZE_ROD, e -> e.setCancelled(true))
                .name("#<5389FD>&lRóżdżka")
                .lore(Arrays.asList("&7Różdżkę możesz zdobyć poprzez #<5389FD>kupienie jej &7w sklepie za &6Dukaty&7.", "&7Ten magiczny przedmiot #<5389FD>niszczy się z każdym użyciem&7.", "", "&7Chociaż jest ona bardzo potężna, może ona", "#<5389FD>stawiać tylko jedną platformę na raz&7."))
